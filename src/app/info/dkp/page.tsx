  ...
  return (
    <div className="py-16 md:py-24">
      <div className="container max-w-3xl">
        <h1 className="font-muller font-bold text-4xl text-body mb-4">ДКП</h1>
        <p className="text-muted font-montserrat text-lg mb-10">Договор купли-продажи автомобиля</p>
